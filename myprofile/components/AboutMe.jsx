    ...
    <div id='aboutme' className='max-w-[1240px] mx-auto  text-black'>
        ...
        <div className='md:flex justify-center items-center p-16'>
            ...
            <div className='flex-wrap justify-center items-center text-justify pt-8 md:pl-8'>
                ...
                <p className='text-xl'>Hi, My name is Sebastián Flores Im currently a fourth year student from the Informatics Engineering career at Universidad Centroamericana José Simeon Cañas.</p>
                <p className='text-xl pt-2 '>Im 21 years old and since I remember Ive always dreamed to became a professional on this area, and now I know I have potential to accomplish this dream. </p>
